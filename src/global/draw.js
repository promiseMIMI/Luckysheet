...
function luckysheetDrawgridRowTitle(scrollHeight, drawHeight, offsetTop) {
    ...
    luckysheetTableContent.textBaseline = Store.luckysheetdefaultstyle.textBaseline; //基准线 垂直居中
    luckysheetTableContent.fillStyle = Store.luckysheetdefaultstyle.fillStyle;
    ...
    for (let r = dataset_row_st; r <= dataset_row_ed; r++) {
        ...
        if (Store.config["rowhidden"] != null && Store.config["rowhidden"][r] != null) {
            ...
            luckysheetTableContent.fillStyle = Store.luckysheetdefaultstyle.fillContentStyle;
            ...
            luckysheetTableContent.fillStyle = Store.luckysheetdefaultstyle.fillHeaderStyle;
        ...
        luckysheetTableContent.strokeStyle = Store.luckysheetdefaultstyle.strokeStyle;
        ...
        if(checksCF != null && checksCF["dataBar"] != null && checksCF["dataBar"]["valueLen"] && checksCF["dataBar"]["valueLen"].toString() !== 'NaN'){
            ...
            if(valueType == 'minus'){
                ...
                if(format.length > 1){
                    ...
                    my_gradient.addColorStop(0, Store.luckysheetdefaultstyle.fillContentStyle);
