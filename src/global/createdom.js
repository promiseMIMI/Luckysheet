...
export default function luckysheetcreatedom(colwidth, rowheight, data, menu, title) {
    ...
    let addControll = '<button id="luckysheet-bottom-add-row" class="btn btn-default">'+'<div class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-none newfont ly-plus" style="user-select: none;">'+'</button><input id="luckysheet-bottom-add-row-input" type="text" class="luckysheet-datavisual-config-input luckysheet-mousedown-cancel" placeholder="'+(luckysheetConfigsetting.addRowCount || 100)+'"><span style="font-size: 13px;color: rgba(255,255,255,0.6500);">'+ locale_info.row +'</span>';
