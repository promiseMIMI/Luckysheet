...
const luckysheetFreezen = {
            ...
            style="user-select: none;">
                ...
                style="user-select: none;">
                    <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                        <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-function newfont ly-donjiediyihang"
                        style="user-select: none;">
                        </div>
                    </div>
    ...
    createFreezenVertical: function (freezenverticaldata, left) {
        ...
        // $("#luckysheet-freezen-btn-horizontal").html('<i class="luckysheet-icon-img-container newfont ly-donjiediyihang"></i> '+locale().freezen.freezenCancel);
    ...
    cancelFreezenHorizontal: function (sheetIndex) {
        ...
        // $("#luckysheet-freezen-btn-horizontal").html('<i class="luckysheet-icon-img-container newfont ly-donjiediyihang"></i> '+locale().freezen.default);
